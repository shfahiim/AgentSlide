...
class RAGPipeline:
    ...
    def ingest_text_files(self, directory: str, extensions: Tuple[str, ...] = (".txt", ".md")) -> None:
        docs = []
    ...
    def ingest_documents(self, docs: Sequence[Document]) -> None:
    ...
    def answer(
        ...
        *,
        ...
        evidence_min_score: float = 0.02,  # for RRF scores, small values are typical
...
def main() -> None:
    ...
    embedder = OpenAIEmbedder(model="text-embedding-3-small", dimensions=None, batch_size=64)
    llm = OpenAIChatLLM(model="gpt-4.1-mini", temperature=0.2)
